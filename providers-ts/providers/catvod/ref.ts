 ...
 *   LiveSourceRef { type:'live-source', index }                       → IPTV source channel list
 *   LiveRef       { type:'live',        name, url }                   → IPTV channel playback
 */
...
export interface LiveSourceRef  { type: 'live-source'; index: number }
