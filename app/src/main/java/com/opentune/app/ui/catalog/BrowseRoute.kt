...
fun BrowseRoute(
    ...
    LaunchedEffect(app, database, providerId, sourceId, locationDecoded) {
        state = CatalogScreenBindingState.Loading
        state = resolveBrowseBinding(app, database, providerId, sourceId, locationDecoded).toScreenState()
    }
