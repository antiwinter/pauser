...
fun Modifier.onTvMenuKeyDown(onMenu: () -> Unit): Modifier = onPreviewKeyEvent { event ->
    ...
    Timber.tag("onTvMenuKeyDown").d("native.keyCode=${native.keyCode}, native.scanCode=${native.scanCode}, native.action=${native.action}")
    val isMenuKey = native.keyCode in listOf(KeyEvent.KEYCODE_MENU,
    KeyEvent.KEYCODE_PAGE_DOWN, KeyEvent.KEYCODE_FORWARD_DEL)
